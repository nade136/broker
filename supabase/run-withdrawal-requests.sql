-- Run this in Supabase Dashboard → SQL Editor to create the withdrawal_requests table.
-- Fixes: "Could not find the table 'public.withdrawal_requests' in the schema cache"
